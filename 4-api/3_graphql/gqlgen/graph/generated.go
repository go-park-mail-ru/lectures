...
func (ec *executionContext) _Book_author(ctx context.Context, field graphql.CollectedField, obj *model.Book) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalOAuthor2ᚖgithubᚗcomᚋgoᚑparkᚑmailᚑruᚋlecturesᚋ4ᚑapiᚋ3_graphqlᚋgqlgenᚋgraphᚋmodelᚐAuthor(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_books(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNBook2ᚕᚖgithubᚗcomᚋgoᚑparkᚑmailᚑruᚋlecturesᚋ4ᚑapiᚋ3_graphqlᚋgqlgenᚋgraphᚋmodelᚐBookᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNBook2ᚕᚖgithubᚗcomᚋgoᚑparkᚑmailᚑruᚋlecturesᚋ4ᚑapiᚋ3_graphqlᚋgqlgenᚋgraphᚋmodelᚐBookᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Book) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNBook2ᚖgithubᚗcomᚋgoᚑparkᚑmailᚑruᚋlecturesᚋ4ᚑapiᚋ3_graphqlᚋgqlgenᚋgraphᚋmodelᚐBook(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNBook2ᚖgithubᚗcomᚋgoᚑparkᚑmailᚑruᚋlecturesᚋ4ᚑapiᚋ3_graphqlᚋgqlgenᚋgraphᚋmodelᚐBook(ctx context.Context, sel ast.SelectionSet, v *model.Book) graphql.Marshaler {
	if v == nil {
...
func (ec *executionContext) marshalOAuthor2ᚖgithubᚗcomᚋgoᚑparkᚑmailᚑruᚋlecturesᚋ4ᚑapiᚋ3_graphqlᚋgqlgenᚋgraphᚋmodelᚐAuthor(ctx context.Context, sel ast.SelectionSet, v *model.Author) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
