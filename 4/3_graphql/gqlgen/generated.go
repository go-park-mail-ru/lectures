...
func (ec *executionContext) _Book_price(ctx context.Context, field graphql.CollectedField, obj *Book) graphql.Marshaler {
	ctx = ec.Tracer.StartFieldExecution(ctx, field)
	defer func() { ec.Tracer.EndFieldExecution(ctx) }()
	rctx := &graphql.ResolverContext{
		Object: "Book",
...
func (ec *executionContext) _Book_author(ctx context.Context, field graphql.CollectedField, obj *Book) graphql.Marshaler {
	...
	rctx.Result = res
	ctx = ec.Tracer.StartFieldChildExecution(ctx)
	return ec.marshalOAuthor2ᚖgqlᚐAuthor(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_books(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	...
	rctx.Result = res
	ctx = ec.Tracer.StartFieldChildExecution(ctx)
	return ec.marshalNBook2ᚕgqlᚐBook(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNBook2gqlᚐBook(ctx context.Context, sel ast.SelectionSet, v Book) graphql.Marshaler {
	return ec._Book(ctx, sel, &v)
}

func (ec *executionContext) marshalNBook2ᚕgqlᚐBook(ctx context.Context, sel ast.SelectionSet, v []Book) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNBook2gqlᚐBook(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalOAuthor2gqlᚐAuthor(ctx context.Context, sel ast.SelectionSet, v Author) graphql.Marshaler {
	return ec._Author(ctx, sel, &v)
}

func (ec *executionContext) marshalOAuthor2ᚖgqlᚐAuthor(ctx context.Context, sel ast.SelectionSet, v *Author) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Author(ctx, sel, v)
